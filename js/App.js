window.CONTRACT = {
  address: '0x0C263f7AB3D758a45F043Ee745Eb687746e983C3',
  network: 'http://127.0.0.1:8545', //https://polygon-rpc.com/
...
async function sendHash() {
  ...
  //   repo: 'Ali-ok' + Math.random(), // Your custom repo name
  //   config: {
  //     Addresses: {
  //       Swarm: [
  //         '/ip4/127.0.0.1/tcp/4001', // Localhost for IPv4
  //         '/ip6/::1/tcp/4001',      // Localhost for IPv6
  //         '/ip4/127.0.0.1/tcp/4003/ws', // Pubsub WebSocket address for IPv4
  //         '/ip6/::1/tcp/4003/ws',      // Pubsub WebSocket address for IPv6
  //       ],
  //       API: '/ip4/127.0.0.1/tcp/5001',    // Custom RPC API server listening address on localhost
  //       Gateway: '/ip4/127.0.0.1/tcp/8080', // Custom Gateway server listening address on localhost
  //     },
  //   },
  // });
