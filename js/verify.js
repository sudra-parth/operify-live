...
async function verify_Hash() {
  $('#loader').show()
  console.log("Inside verify_hash");
  if (window.hashedfile) {
    ...
    */
    await contract.methods
      ...
      .then((result) => {
        console.log("Inside contracts method");
        console.log(result)
...
function checkURL() {
  ...
  if (!window.hashedfile) {
    console.log("No hashed file inside check url")
  }
  else {
    verify_Hash()
  }
